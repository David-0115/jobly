...
describe("POST /companies", function () {
  ...
  test("requires admin to create - non admin is unauthorized", async function () {
  ...
  test("requires admin to create - admin can create", async function () {
    const resp = await request(app)
      .post("/companies")
      .send(newCompany)
...
describe("GET /companies", function () {
  ...
  describe("GET /companies?querystring", function () {
    ...
    test("throws error if invalid query", async function () {
      const resp = await request(app).get("/companies?notValid=10");
      expect(resp.body).toEqual({
        "error": {
    ...
    test("throws error if minEmployees is greater than maxEmployees", async function () {
      ...
      expect(resp.body).toEqual({
        "error": {
          "message": "Invalid request, minEmployees can not exceed maxEmployees",
          "status": 400
        }
      });
    });
