...
class User {
  ...
  /** Given a username and jobId inserts into applications
   * 
   * Throws NotFoundError if username or jobId aren't found
   * 
  ...
  static async apply(username, jobId) {
    try {
      ...
      if (err.code === '23505') {
        throw new ExpressError(`Application already exists for username: ${username} and jobId: ${jobId}`, 400);
      }
      if (err.code === '23503') {
